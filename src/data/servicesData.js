...
export const services = [
    {
        ...
        sections: [
            ...
            },
            {
                ...
                body:
                    "We handle brake-related work, air systems, suspension, airbags, lighting, roof issues, structural repairs, welding, landing gear, and general trailer service.",
            },
            {
    ...
    {
        slug: "mobile-fleet-service",
        navLabel: "Mobile Fleet Service",
        kicker: "Mobile Service",
        ...
        sections: [
            {
                ...
                body:
                    "We service trailers at fleet yards, warehouses, trucking terminals, distribution centers, and customer facilities. This reduces unnecessary equipment movement and helps fleets handle multiple units more efficiently.",
            },
            {
                title: "What mobile service covers",
                body:
                    "Mobile service can include trailer repair, DOT-related repairs, PM inspections, lighting repairs, air system issues, suspension work, and emergency fleet support.",
            },
            {
                title: "When mobile becomes in-shop",
                body:
                    "Some repairs require more time, heavier work, or controlled shop conditions. When that happens, we schedule the unit for in-shop service instead of forcing the wrong repair environment.",
            },
        ],
        bullets: [
            "On-site trailer repair",
            "Fleet yard service",
            "Mobile DOT-related repairs",
            "Mobile PM inspections",
            "Multiple-unit fleet support",
        ],
        cta: "Schedule Mobile Service",
    },
    {
        slug: "in-shop-trailer-service",
        navLabel: "In-Shop Trailer Service",
        kicker: "Scheduled Service",
        title: "In-Shop Trailer Service",
        short:
        ...
        bullets: [
            "Scheduled trailer drop-off",
            "Longer repair windows",
            "Structural or detailed repair work",
            "Controlled service environment",
            "Fleet maintenance support",
        ],
        cta: "Schedule In-Shop Service",
    },
    {
        ...
        sections: [
            {
                ...
                body:
                    "DOT work is about roadworthiness and safety. If a trailer has issues that prevent it from being inspection-ready, we help identify and repair those problems.",
            },
            {
    ...
    },
    {
        ...
        sections: [
            {
                ...
                body:
                    "When a trailer issue stops operations, the priority is getting the unit safe, functional, or properly routed for a full repair.",
            },
            {
                title: "Common roadside issues",
                body:
        ...
        bullets: [
            ...
            "Air and brake-related problems",
            "Suspension issues",
            "Temporary operational fixes",
        ],
        cta: "Request Roadside Help",
    },
    {
        ...
        sections: [
            {
                ...
                body:
                    "We handle curtain-side manufacturing, installation, repair, replacement, and maintenance for commercial trailer equipment.",
            },
            {
